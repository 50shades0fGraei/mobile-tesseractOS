...
function Home() {
    return (<main className="min-h-dvh bg-gray-900 text-white flex flex-col items-center justify-center p-8 font-sans">
      <div className="text-center max-w-3xl">
        ...
        <div className="bg-gray-800 p-8 rounded-2xl shadow-2xl border border-gray-700">
          ...
          <a href="#" // Placeholder for the actual download link
